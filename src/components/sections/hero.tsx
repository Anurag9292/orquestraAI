...
import { ArrowRight, Sigma, BrainCircuit, Binary } from 'lucide-react'
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-sm">
            ...
            <span className="text-gray-300">Deep Tech AI &middot; Mathematical Foundations &middot; Statistical Intelligence</span>
          </div>
          ...
          <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-gradient">Mathematically Rigorous</span>
            <br />
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            We build AI from first principles — grounded in statistics, probability theory,
            and deep mathematical frameworks. Not wrappers around APIs.
            Real intelligence, engineered with precision.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 glass rounded-xl p-4">
              <BrainCircuit className="h-6 w-6 text-brand-400 flex-shrink-0" />
              <span className="text-sm text-gray-300">Deep Neural Architectures</span>
            </div>
            <div className="flex items-center justify-center gap-3 glass rounded-xl p-4">
              <Sigma className="h-6 w-6 text-accent-cyan flex-shrink-0" />
              <span className="text-sm text-gray-300">Statistical Modeling</span>
            </div>
            <div className="flex items-center justify-center gap-3 glass rounded-xl p-4">
              <Binary className="h-6 w-6 text-accent-emerald flex-shrink-0" />
              <span className="text-sm text-gray-300">Systems Engineering</span>
            </div>
          </div>
        </div>
      </div>
